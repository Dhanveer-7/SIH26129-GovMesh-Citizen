...
| **GovMesh Core Engine** | Render / Node.js | `http://localhost:5000` (Local) / Cloud Host |
| **Revenue Backend** | Render | `https://sih-2026-revenue-dept.onrender.com` |
| **Food Department** | Vercel / Spring Boot | `https://sih-flax-rho.vercel.app/` / `http://localhost:8081` |
| **Rural Development** | Vercel | `https://sih-26129-gov-mesh-rural-develpment-qict005hp-josh06.vercel.app/` |
...
PORT=5000
NODE_ENV=production
FRONTEND_ORIGIN=https://sih-26129-gov-mesh-citizen.vercel.app,http://localhost:5173
REVENUE_API_BASE_URL=https://sih-2026-revenue-dept.onrender.com
FOOD_API_BASE_URL=http://localhost:8081
